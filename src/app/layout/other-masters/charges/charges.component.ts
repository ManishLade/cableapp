...
@Component({
    ...
    entryComponents: [AddChargesComponent, EditChargesComponent, DeleteDialogComponent]
})
export class ChargesComponent implements OnInit {
    ...
    addCharges() {
        this.router.navigate(['/charges/add'], {
    ...
    private refreshTable() {
        ...
        // https://github.com/marinantonio/angular-mat-table-crud/chargess/12
